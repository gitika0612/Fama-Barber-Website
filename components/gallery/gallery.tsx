...
const Gallery = () => {
  ...
  const [direction, setDirection] = useState(0); // track direction of slide
  ...
  // Handle page change with direction tracking
      ...
      <div className="relative overflow-hidden min-h-[300px]">
        <AnimatePresence custom={direction} mode="wait">
          <motion.div
            ...
            className="grid grid-cols-1 md:grid-cols-3 gap-6 absolute top-0 left-0 w-full"
          >
